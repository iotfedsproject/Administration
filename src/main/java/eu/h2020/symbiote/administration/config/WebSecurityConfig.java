...
public class WebSecurityConfig {
    ...
    public static class ComponentControllerWebSecurityConfigurerAdapter extends WebSecurityConfigurerAdapter {
        ...
        protected void configure(HttpSecurity http) throws Exception {
            ...
            http
                .antMatcher("/administration/generic/**")
                    .cors()
                    .and()
                .csrf()
                    .disable();
    ...
    public static class TestWebSecurityConfigurerAdapter extends WebSecurityConfigurerAdapter {
        ...
        protected void configure(HttpSecurity http) throws Exception {
            ...
            http
                    .antMatcher("/administration/federation_vote_request/**").csrf().disable().authorizeRequests().anyRequest().authenticated().and().httpBasic();
//            http
//                .antMatcher("/administration/federation_join_request/**")
//                    .cors()
//                    .and()
//                .csrf()
//                    .disable();
