...
//            UserDetailsResponse response = new UserDetailsResponse(HttpStatus.valueOf(200), userDetails);
//            test
            ...
            if(response != null) {
                if (response.getHttpStatus() == HttpStatus.OK ||
                    ...
                    CoreUser user = new CoreUser(name, password, true, true, true,
                            ...
                            response.getUserDetails().hasGrantedServiceConsent(), response.getUserDetails().hasGrantedAnalyticsAndResearchConsent(), null, null);
...
//        } catch(Exception e){
    ...
    public boolean supports(Class<?> authentication) {
        return (UsernamePasswordAuthenticationToken.class.isAssignableFrom(authentication) || BasicAuthentication.class.isAssignableFrom(authentication));
    }
