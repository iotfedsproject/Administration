...
public class RegisterControllerImpl implements RegisterController {
    ...
    @Override
    public Map<String, Object> coreUserRegister(@RequestBody String JsonRequest)
        ...
        log.debug("POST request on /administration/registerUser");
        log.debug("CoreUser = " + jsonObject.get("Username"));

//        userService.validateUserRegistrationForm(coreUser, bindingResult);
        userService.createUserAccount(JsonRequest);
